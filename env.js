 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.petfluent.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.petfluent'; // ios bundle id
const PACKAGE = 'com.petfluent'; // android package name
const NAME = 'PetFluent'; // app name
const EXPO_ACCOUNT_OWNER = 'cmogusu'; // expo account owner
const EAS_PROJECT_ID = 'setId'; // eas project id
const SCHEME = 'petfluent'; // app scheme
